...
_defineProperty(Algos, "displayTodos", function () {
  ...
  todoList.forEach(function (item) {
    ...
    document.getElementById('todo-list-items').append(Algos.CreateTodo(item, currentStatus, iscompleted));
  });
  Algos.addTask();
  Algos.editTodoBtn();
  Algos.editTodoClick();
...
document.querySelector('.clear-completed').addEventListener('click', _modules_DeleteCompleted_js__WEBPACK_IMPORTED_MODULE_2__["default"].clearCompleted);
...
/******/ })()
;
//# sourceMappingURL=bundlecd25b6b744970365d505.js.map